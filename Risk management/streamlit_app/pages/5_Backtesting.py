...
st.set_page_config(page_title="Backtesting · Tier 5", layout="wide")
apply_theme()
render_sidebar()

hero(
    "Backtesting · Forecast vs. Realized",
    eyebrow="Tier 5 · Outcomes Analysis (SR 11-7) · EBA Vintages 2020-2025",
    deck="Validierungs-Suite gegen die historischen EBA-Transparency-"
         "Vintages: 22 Quartals-Stichtage von Q3 2019 bis Q2 2025, "
         "~120 Banken pro Stichtag, ~2 600 Bank-Quartal-Observationen. "
         "Empirische Sensitivität, Stress-Episode-Vergleich und RWA-"
         "Decomposition.",
)
