...
st.markdown(
    ...
    'Forward-Stress-Startpunkt im Live-Cockpit. Der Backtest nutzt separat '
    'die historische Pillar-3-Rohreihe <code>pillar3_backtest_pdlgd.csv</code> '
    '(2021–2024): 255 quellenbelegte EU-CR6-Zeilen, davon 253 modellfähig; '
    'je Quartal im Jahr Y wird 31.12.(Y−1) eingefroren, also ohne '
    'Look-ahead.<br><br>'
